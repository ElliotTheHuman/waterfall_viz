...
(function() {
  ...
  var total = 0;
  var dt2 = [];
  var number_of_measures = queryResponse.fields.measure_like.length;

  for (var i = 0; i < number_of_measures/2; i++) { 
      ...
      if (name_value == "Won") {
        color_value = "#ADFCC0"; // Good Color
      } else if (name_value == "Lost") {
        color_value = "#F1AEAC"; // Bad Color 
      } else {
        color_value = "#F9E0A6";  // Neutral Color
      }
